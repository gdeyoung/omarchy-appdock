...
```bash
curl -fsSL https://github.com/gdeyoung/omarchy-appdock/archive/refs/tags/v0.2.3.tar.gz | tar xz -C /tmp
less /tmp/omarchy-appdock-0.2.3/install.sh   # review before running — it's your machine
/tmp/omarchy-appdock-0.2.3/install.sh
...
```bash
git clone --depth 1 --branch v0.2.3 https://github.com/gdeyoung/omarchy-appdock.git
cd omarchy-appdock
./install.sh
omarchy restart shell
```
